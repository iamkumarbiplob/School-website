...
<html>
	<head>
		<title>Assistant Headmaster || SAHS</title>
	...
	<body onload=display_ct();>
		...
		<div style="clear: both;"></div>
		<h1 style="text-align:center;">Assistant Head Master</h1>

		<div class="flip-card">
		  <div class="flip-card-inner">
		    <div class="flip-card-front">
		      <img src="img/biplob1.jpg" alt="Assistant headmaster image" style="width:300px;height:300px;">
		    </div>
		    <div class="flip-card-back">
		      <h1>Biplob Kumar</h1> 
		      <p>Asistant Head Master</p> 
